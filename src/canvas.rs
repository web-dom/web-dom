...
pub fn buffer_data(
    ...
    unsafe { canvas_buffer_data(instance, target, size, usage) }
}
extern "C" {
    fn canvas_buffer_data_1(
        instance: DOMReference,
...
pub fn buffer_data_1(
    ...
    unsafe { canvas_buffer_data_1(instance, target, data, usage) }
}
extern "C" {
    fn canvas_buffer_data_2(
        instance: DOMReference,
...
pub fn buffer_data_2(
    ...
    unsafe { canvas_buffer_data_2(instance, target, data, usage) }
}
extern "C" {
    fn canvas_buffer_sub_data(
        instance: DOMReference,
...
pub fn buffer_sub_data(
    ...
    unsafe { canvas_buffer_sub_data(instance, target, offset, data) }
}
extern "C" {
    fn canvas_buffer_sub_data_1(
        instance: DOMReference,
...
pub fn buffer_sub_data_1(
    ...
    unsafe { canvas_buffer_sub_data_1(instance, target, offset, data) }
}
extern "C" {
    fn canvas_compressed_tex_image2_d(
        instance: DOMReference,
...
pub fn compressed_tex_image2_d(
    ...
    unsafe {
        canvas_compressed_tex_image2_d(
            instance,
            target,
            level,
            internalformat,
...
extern "C" {
    fn canvas_compressed_tex_sub_image2_d(
        instance: DOMReference,
...
pub fn read_pixels(
    ...
    unsafe { canvas_read_pixels(instance, x, y, width, height, format, pixel_type, pixels) }
}
extern "C" {
    fn canvas_tex_image2_d(
        instance: DOMReference,
...
pub fn tex_sub_image2_d_2(
    ...
    unsafe {
        canvas_tex_sub_image2_d_2(
            instance, target, level, xoffset, yoffset, format, image_type, pixels,
        )
    }
}
extern "C" {
    fn canvas_tex_sub_image2_d_3(
        instance: DOMReference,
...
pub fn tex_sub_image2_d_5(
    ...
    unsafe {
        canvas_tex_sub_image2_d_5(
            instance, target, level, xoffset, yoffset, format, image_type, video,
        )
    }
}
extern "C" {
    fn canvas_uniform1fv(
        instance: DOMReference,
        uniform1fv: DOMReference,
        uniform1fv: DOMReference,
    );
}

pub fn uniform1fv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform1fv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform2fv(
        instance: DOMReference,
        uniform2fv: DOMReference,
        uniform2fv: DOMReference,
    );
}

pub fn uniform2fv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform2fv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform3fv(
        instance: DOMReference,
        uniform3fv: DOMReference,
        uniform3fv: DOMReference,
    );
}

pub fn uniform3fv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform3fv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform4fv(
        instance: DOMReference,
        uniform4fv: DOMReference,
        uniform4fv: DOMReference,
    );
}

pub fn uniform4fv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform4fv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform1iv(
        instance: DOMReference,
        uniform1iv: DOMReference,
        uniform1iv: DOMReference,
    );
}

pub fn uniform1iv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform1iv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform2iv(
        instance: DOMReference,
        uniform2iv: DOMReference,
        uniform2iv: DOMReference,
    );
}

pub fn uniform2iv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform2iv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform3iv(
        instance: DOMReference,
        uniform3iv: DOMReference,
        uniform3iv: DOMReference,
    );
}

pub fn uniform3iv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform3iv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform4iv(
        instance: DOMReference,
        uniform4iv: DOMReference,
        uniform4iv: DOMReference,
    );
}

pub fn uniform4iv(instance: DOMReference, location: DOMReference, data: DOMReference) {
    unsafe { canvas_uniform4iv(instance, location, data) }
}
extern "C" {
    fn canvas_uniform_matrix2fv(
        instance: DOMReference,
...
pub fn uniform_matrix2fv(
    ...
    unsafe { canvas_uniform_matrix2fv(instance, location, transpose, data) }
}
extern "C" {
    fn canvas_uniform_matrix3fv(
        instance: DOMReference,
...
pub fn uniform_matrix3fv(
    ...
    unsafe { canvas_uniform_matrix3fv(instance, location, transpose, data) }
}
extern "C" {
    fn canvas_uniform_matrix4fv(
        instance: DOMReference,
...
pub fn uniform_matrix4fv(
    ...
    unsafe { canvas_uniform_matrix4fv(instance, location, transpose, data) }
}
extern "C" {
    fn canvas_commit(instance: DOMReference);
}

pub fn commit(instance: DOMReference) {
    unsafe { canvas_commit(instance) }
}
