...
extern "C" {
    fn element_get_attribute_names(instance: DOMReference) -> i32;
}

pub fn get_attribute_names(instance: DOMReference) -> i32 {
...
pub fn closest(instance: DOMReference, selector: &str) -> i32 {
...
pub fn get_elements_with_grid(instance: DOMReference) -> i32 {
...
extern "C" {
    fn element_insert_adjacent_element(
        ...
        insert_adjacent_element: i32,
    ) -> i32;
}

pub fn insert_adjacent_element(instance: DOMReference, location: &str, element: i32) -> i32 {
...
pub fn get_attribute_node(instance: DOMReference, name: &str) -> i32 {
    unsafe { element_get_attribute_node(instance, to_cstring(name)) }
}
extern "C" {
    fn element_set_attribute_node(instance: DOMReference, set_attribute_node: i32) -> i32;
}

pub fn set_attribute_node(instance: DOMReference, new_attr: i32) -> i32 {
    unsafe { element_set_attribute_node(instance, new_attr) }
}
extern "C" {
    fn element_remove_attribute_node(instance: DOMReference, remove_attribute_node: i32) -> i32;
}

pub fn remove_attribute_node(instance: DOMReference, old_attr: i32) -> i32 {
...
extern "C" {
    fn element_set_attribute_node_n_s(instance: DOMReference, set_attribute_node_n_s: i32) -> i32;
}

pub fn set_attribute_node_n_s(instance: DOMReference, new_attr: i32) -> i32 {
...
pub fn get_as_flex_container(instance: DOMReference) -> i32 {
    unsafe { element_get_as_flex_container(instance) }
}
extern "C" {
    fn element_get_grid_fragments(instance: DOMReference) -> i32;
}

pub fn get_grid_fragments(instance: DOMReference) -> i32 {
    unsafe { element_get_grid_fragments(instance) }
}
extern "C" {
    fn element_get_transform_to_ancestor(
        instance: DOMReference,
        get_transform_to_ancestor: i32,
    ) -> i32;
}

pub fn get_transform_to_ancestor(instance: DOMReference, ancestor: i32) -> i32 {
    unsafe { element_get_transform_to_ancestor(instance, ancestor) }
}
extern "C" {
    fn element_get_transform_to_parent(instance: DOMReference) -> i32;
}

pub fn get_transform_to_parent(instance: DOMReference) -> i32 {
    unsafe { element_get_transform_to_parent(instance) }
}
extern "C" {
    fn element_get_transform_to_viewport(instance: DOMReference) -> i32;
}

pub fn get_transform_to_viewport(instance: DOMReference) -> i32 {
    unsafe { element_get_transform_to_viewport(instance) }
}
extern "C" {
    fn element_get_client_rects(instance: DOMReference) -> i32;
}

pub fn get_client_rects(instance: DOMReference) -> i32 {
    unsafe { element_get_client_rects(instance) }
}
extern "C" {
    fn element_get_bounding_client_rect(instance: DOMReference) -> i32;
}

pub fn get_bounding_client_rect(instance: DOMReference) -> i32 {
    unsafe { element_get_bounding_client_rect(instance) }
}
extern "C" {
    fn element_scroll_into_view(instance: DOMReference, scroll_into_view: i32);
}

pub fn scroll_into_view(instance: DOMReference, arg: i32) {
...
extern "C" {
    fn element_query_selector(instance: DOMReference, query_selector: CString) -> i32;
}
...
extern "C" {
    fn element_query_selector_all(instance: DOMReference, query_selector_all: CString) -> i32;
}
...
extern "C" {
    fn element_prepend(instance: DOMReference, prepend: i32);
}

pub fn prepend(instance: DOMReference, nodes: i32) {
    unsafe { element_prepend(instance, nodes) }
}
extern "C" {
    fn element_append(instance: DOMReference, append: i32);
}

pub fn append(instance: DOMReference, nodes: i32) {
    unsafe { element_append(instance, nodes) }
}
extern "C" {
    fn element_before(instance: DOMReference, before: i32);
}

pub fn before(instance: DOMReference, nodes: i32) {
    unsafe { element_before(instance, nodes) }
}
extern "C" {
    fn element_after(instance: DOMReference, after: i32);
}

pub fn after(instance: DOMReference, nodes: i32) {
    unsafe { element_after(instance, nodes) }
}
extern "C" {
    fn element_replace_with(instance: DOMReference, replace_with: i32);
}

pub fn replace_with(instance: DOMReference, nodes: i32) {
